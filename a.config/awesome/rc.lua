...
do
    ...
    awesome.connect_signal("debug::error", function (err)
        -- Make sure we don't go into an endless error 
...
globalkeys = gears.table.join(
    ...
    -- LaunchAfpps
    awful.key({ modkey }, "f", function () awful.util.spawn("librewolf") end,
...
-- startup script
awful.spawn.with_shell("/home/bash/.config/awesome/start.sh")
